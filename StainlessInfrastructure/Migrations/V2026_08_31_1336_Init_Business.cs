...
public sealed class V2026_08_31_1336_Init_Business : Migration
{
    public override void Up()
    {
        ...
        Create.Table("project_type_translation")
            .InSchema(Globals.Schema.Reference)
            .WithColumn("id").AsGuid().NotNullable().PrimaryKey()
            .WithColumn("project_type_id").AsString(1024).NotNullable().ForeignKey("fk_project_type_translation_to_project_type", Globals.Schema.Reference, "project_type", "id").OnDelete(System.Data.Rule.Cascade)
        ...
        Create.Table("project")
            ...
            .WithColumn("division_id").AsString(Globals.ColumnLength.ProjectId).NotNullable()
                .ForeignKey("fk_division_id_to_division", Globals.Schema.Reference, "division", "id")
                .OnDelete(Rule.Cascade)
            .WithColumn("project_type_id").AsString().NotNullable()
